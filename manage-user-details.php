...
$driver_query = mysqli_query($con, "SELECT tbl_login.login_id, tbl_login.status, name,email_id,phone_no,address, vehicle_number, tbl_login.status FROM tbl_driver_registration JOIN tbl_login ON tbl_login.login_id = tbl_driver_registration.login_id");
        ...
        <div class="col-md-7">
            <div class="page-breadcrumb-wrap">
                ...
                <div class="page-breadcrumb-info">
                    <h2 class="breadcrumb-titles">Manage Drivers <small> Ae Auto</small></h2>
                    <ul class="list-page-breadcrumb">
                        <li><a href="dashboard">Home</a>
                        </li>
                        <li class="active-page"> Drivers List</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="box-widget widget-module">
                            ...
                            <div class="widget-container">
                                <div class=" widget-block">
                                    ...
                                    <?php $i=0; while($row_data = mysqli_fetch_assoc($driver_query)) { $i++; ?>
                                    <tr>
                                        <td align="center">
                                        <?php echo $i; ?>  
                                        </td>
                                        ...
                                        <td align="center">
                                            <?php echo $row_data['email_id']; ?>
                                        </td>
                                        <td align="center">
                                           <?php echo $row_data['phone_no']; ?>
                                        </td>
                                        <td align="center">
                                            <?php echo $row_data['address']; ?>
                                        </td>
                                        <td align="center">
                                            <?php echo $row_data['vehicle_number']; ?>
                                        </td>
                                        <td align="center">
